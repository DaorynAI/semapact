...
def test_changeset_identity_changes_with_exact_revision() -> None:
...
def test_changeset_from_decision_reuses_authoritative_changes_without_date_context() -> None:
    ...
    assert not hasattr(change_set, "context")
