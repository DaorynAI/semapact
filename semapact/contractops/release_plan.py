...
from semapact.contractops.integrity import (
    SEMAPACT_RELEASE_PLAN_NAMESPACE,
    compute_release_plan_id,
)
...
def build_release_plan(
    ...
    # Release planning is a pure PROPOSE operation. Reuse the authoritative gate
    ...
    if publish_gate.allowed:
        ...
        # PROPOSE already rejects BLOCK. Reaching this state would mean the gate
    ...
    release_plan_id = compute_release_plan_id(
